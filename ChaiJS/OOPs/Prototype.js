...
//Object.setPrototypeOf(trueLength, trim().length)
...
console.log(TeachingSupport.makeVideo);// can access Teacher  properties
console.log(TASupport.isAvailable);// can't access it 

//==========

let anotherUsername = "Toby     "
